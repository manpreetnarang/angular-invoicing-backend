...
class InvoiceItemsControllerTest < ActionController::TestCase
  ...
  test "should create invoice_item" do
    assert_difference('InvoiceItem.count') do
      post :create, invoice_item: { cost: @invoice_item.cost, description: @invoice_item.description, invoice_id: @invoice_item.invoice_id, qty: @invoice_item.qty, total: @invoice_item.total }
    end
  ...
  test "should update invoice_item" do
    patch :update, id: @invoice_item, invoice_item: { cost: @invoice_item.cost, description: @invoice_item.description, invoice_id: @invoice_item.invoice_id, qty: @invoice_item.qty, total: @invoice_item.total }
    assert_redirected_to invoice_item_path(assigns(:invoice_item))
  end
